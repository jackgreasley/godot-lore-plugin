...
// lore.h (generated from third_party/lore's lore-capi crate, staged by CMake
// at build time) is generated with cbindgen's `language = "C"` and has no
// `__cplusplus` guard, so it never adds `extern "C"` itself.
